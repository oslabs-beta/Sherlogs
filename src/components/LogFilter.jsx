    ...
    <div className=' bg-main mr-3 ml-3 mt-5 pr-2 pl-2 rounded-md flex items-center justify-between'>
      ...
      <div className='py-1 px-1 m-1'>
        <input
          ...
          type='text'
          className='w-full shadow shadow-dark bg-main_twenty h-9 rounded-md px-2 placeholder:text-white placeholder:text-md placeholder:pl-3 text-white text-md font-medium'
